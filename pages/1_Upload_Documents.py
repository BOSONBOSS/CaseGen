...
st.markdown('<div class="page-desc">Add every file you want the AI to read. </div>', unsafe_allow_html=True)
...
with col_next:
    if st.button("Configure", type="primary" if can_proceed else "secondary", use_container_width=True):
        if not transcript:
